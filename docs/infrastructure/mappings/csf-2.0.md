...
| **ID.RA-03** | Internal and external threats to the organisation are identified and recorded | Risk Tiers, threat model templates | Threat models in [Templates](../../extensions/templates/README.md) address AI-specific threats: adversarial inputs, model manipulation, supply chain compromise |
